            ...
            # derivative
                ...
                # Not derivative
                    ...
                    result[mask] = np.divide(np.multiply(
                        ...
                        np.power(np.log1p(y[mask]), derivative)) - np.multiply(derivative, p[mask]), lmbda[mask])
                    ...
                    result[mask] = np.divide(-(np.multiply(
                        ...
                        np.power(-np.log1p(-y[mask]), derivative)) - np.multiply(derivative, p[mask])), 2 - lmbda[mask])
